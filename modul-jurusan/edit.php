...
if ($edit) {
    ...
    $data = null; // Handle the error as needed
}
?>
            ...
            <div class="card-body">
                <form action="update.php" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" value="<?= isset($data['kode']) ? $data['kode'] : '' ?>" name="kode" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Nama Jurusan</label>
                        <input type="text" value="<?= isset($data['jurusan']) ? $data['jurusan'] : '' ?>" name="jurusan" class="form-control" id="exampleInputPassword1">
                    </div>
